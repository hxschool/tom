        	...
        	<table width="100%" cellpadding="5" border="0" class="tm_table_form">
            	<tbody>
					...
					<tr>
                        ...
                        <td>
							<input type="password" id="u_userpass" name="u_userpass" class="tm_txt" size="50" maxlength="30" readonly/>
					...
					<tr>
                        ...
                        <td><input type="text" name="u_remark" class="tm_txt" size="50" value="${user.u_remark}" maxlength="30" readonly/></td>
                    </tr>
                </tbody>
